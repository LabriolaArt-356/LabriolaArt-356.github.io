...
SkyboxTexture = new THREE.CubeTextureLoader()
  					...
  					.load( [ 'water.jpg', 'dark-s_nx.jpg', 'dark-s_py.jpg', 'dark-s_ny.jpg', 'dark-s_pz.jpg', 'dark-s_nz.jpg' ] );
...
var texture0 = textureLoader.load( 'textures/water.jpg' );
...
function loadModels() {
  ...
  loader.load( 'models/Amethyst.glb', gltf => onLoad( gltf, Position2, newStandard), onProgress, onError );

  const Position3 = new THREE.Vector3( 0,0, 0 );
  loader.load( 'models/Amethyst.glb', gltf => onLoad( gltf, Position3, SkyboxMaterial), onProgress, onError );

  const Position4 = new THREE.Vector3( 40,0, 0 );
  loader.load( 'models/Amethyst.glb', gltf => onLoad( gltf, Position4, refractorySkybox), onProgress, onError );
